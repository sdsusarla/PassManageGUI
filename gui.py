...
class PasswordManagerGUI:
    def __init__(self, root):
        ...
        # Apply standard style configurations
    ...
    def configure_styles(self):
        # Configure TFrame and other container elements
    ...
    def create_button(self, parent, text, command, bg_key="accent", fg_key="text", hover_key=None, font=("Segoe UI", 10, "bold"), **kwargs):
        ...
        if hover_key is None:
            # Automatic hover key determination
    ...
    def build_sidebar(self):
        ...
        # List of records with scrollbar
    ...
    def refresh_records_list(self):
        # Fetch current record directories
    ...
    def enable_edit_mode(self, record_name):
        ...
        # Make entry widgets interactive
    ...
    def disable_edit_mode(self, record_name):
        self.edit_mode_var.set(False)
        self.show_record_detail(record_name) # Discards modifications by reloading
    ...
    def show_add_record_dialog(self):
        ...
        # Center dialouge relative to parent
        ...
        # Title field (must not have spaces, like addpass.py)
        ...
        def save_new():
            ...
            try:
                ...
                # Encrypt utilizing master_key (hashed master password)
                ...
                # Highlight and load the newly created record
                try:
    ...
    def show_change_master_dialog(self):
        ...
        def handle_change():
            ...
            # Perform re-encryption of all records
            records = passutils.return_records("VAULT")
            hashed_new = encryptutils.hash_(new_pw)
            
            # Step 1: Read and decrypt all passwords into memory
            decrypted_records = {}
            try:
                for rec in records:
            ...
            # Step 2: Write back re-encrypted data
            success_count = 0
            try:
                ...
                # Step 3: Write new master password to file
                with open("VAULT/MASTERPASS.txt", "w") as f:
                    f.write(str(hashed_new))
                    
                # Step 4: Update state with new master_key
    ...
    def copy_to_clipboard(self, text, field_name):
        ...
        # Show premium non-blocking "Copied" alert toast at bottom right of detail pane
